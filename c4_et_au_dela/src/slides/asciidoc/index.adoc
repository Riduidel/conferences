...
[.columns]
[%notitle]
=== Quelques solutions inefficaces (que nous utilisons tous)
...
* https://owulveryck.github.io/cue4puml4c4/[icon:github[] cue4puml4c4] (Spécialement pour Olivier Wulveryck 😘)
* https://riduidel.github.io/aadarchi/[icon:github[] aadarchi] (mon interprétation)
